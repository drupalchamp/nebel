 ...
 */
class MergeVariations extends ControllerBase {
  ...
  public function merge() {
        ...
        if(isset($_GET['skus']) && isset($_GET['product_title'])){
          ...
          if (!empty($product_ids)) {
            ...
            if (isset($product) || !empty($product)) {
                ...
                \Drupal::logger('Merge Product')->notice('Selected Products merged into '.$product_id);
