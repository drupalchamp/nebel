...
Drupal.behaviors.myBehavior = {
        ...
        attach: function (context, settings) {
                ...
                if (location.pathname.includes('/product')) {
                        ...
                        if (currentLangcode == 'de' && mainPrice != null) {
                                                ...
                                                if (allQuantities != null && allPrices != null) {
                                                        ...
                                                        if (allQuantities.length > 1) {
                                                                ...
                                                                //     if (currentLangcode == 'de') {
                                                                        ...
                                                                        mainPrice.innerText = '€' + intPart + ',' + decimalPart;
                                                                //     }
                                                                ...
                                                                let rawPrice = allPrices[0].innerText;
                                                                let cleanedPrice = rawPrice.replace(/[^0-9.,]/g, '').replace(',', '.');
                                                                ...
                                                                if (currentLangcode == 'de') {
                                                                        ...
                                                                        mainPrice.innerText ='€' + calculated_price_2_decimal;  
                                                                }
                                                        }
                                                }
                                        }
